...
extension CompositionalModel {
    static let modelsArray = [
        [CompositionalModel(mainTitle: "Featured Collection", description: "Biography", image: "biography"),
         CompositionalModel(mainTitle: "Featured Collection", description: "Short Stories", image: "short"),
         CompositionalModel(mainTitle: "Featured Collection", description: "History", image: "history"),
         CompositionalModel(mainTitle: "Featured Collection", description: "Philosophy", image: "philosophy"),
         CompositionalModel(mainTitle: "Featured Collection", description: "Poetry", image: "poety")
        ],
